...
@Component({
    moduleId: module.id,
    selector: 'history-commongrid',
    templateUrl: './history_commongrid.html',
    host: {
        '(document:click)': 'onDocumentClick($event)',
    },
})

export class history_commongrid_Component {
    @Input() ModuleType: string = "history"; //history|solution|problem|change
    @Input() records: any;
    allItems: Array<any>[];
